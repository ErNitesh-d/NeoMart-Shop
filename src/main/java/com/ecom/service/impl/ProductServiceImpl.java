...
import java.nio.file.StandardCopyOption; // Correct import for StandardCopyOption
...
public class ProductServiceImpl implements ProductService {
	...
	@Override
	public Product updateProduct(@ModelAttribute Product product, @RequestParam("file") MultipartFile image)
			throws IOException {
	...
	public List<Product> getSuggestions(String ch) {
		return productRepository.findByTitleContainingIgnoreCase(ch);
	}
